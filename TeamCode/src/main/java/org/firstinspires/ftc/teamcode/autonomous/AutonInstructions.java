...
import static org.firstinspires.ftc.teamcode.common.FieldConstants.mmPerBlock;

/**
 * Created by efyang on 1/11/18.
 */

public class AutonInstructions {
    ...
    public AutonInstructions(StartLocation start) {
        switch (start) {
            case BLUE_RIGHT:
    ...
    public boolean has_instructions() {
        return ptr < instructions.length;
    }

    public Pair<InstructionType, Pair<VectorF, Float>> next_instruction() {
