...
public class ArmTester extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Arm arm = new ThreeDOFArm(arm1, arm2, arm3, (float)Math.toRadians(0), (float)Math.toRadians(165), (float)Math.toRadians(-165), telemetry);
        VectorF target = new VectorF(20, 20, 20);
        float ADJUSTMENT_MULTIPLIERS = 1;
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Previous target", target);
